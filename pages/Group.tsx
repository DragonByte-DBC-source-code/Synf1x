        ...
        <div className="w-full max-w-screen-xl">
          <div className="flex justify-center items-center mb-6 top-3">
            <button
              ...
              className="md:left-11 top-3 absolute bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 mb-4 rounded flex items-center max-sm:left-2"
            >
              <ArrowIcon />
            </button>
          ...
          <div className="flex flex-col absolute mt-36 left-2">
            <ChannelsMenu
          ...
          <div className="mx-auto flex flex-col items-center mb-10 md:pl-2">
            {messages && (
              <>
                <div
                  style={{
